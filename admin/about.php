<?php require_once "includes/header.php"; ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 order-md-2">
            <div class="block-16">
              <figure>
                <img src="img/photo-1541339907198-e08756dedf3f.jpg" alt="Image placeholder" class="img-fluid">
              </figure>
            </div>
          </div>
    ...
    <div class="container site-section element-animate">
      ...
      <div class="block-3 d-md-flex pt-5">
        <div class="image" style="background-image: url('img/photo-1464582920526-52639da1ce12.jpg'); "></div>
        <div class="text">
      ...
      <div class="block-3 d-md-flex">
        <div class="image order-2" style="background-image: url('img/photo-1495995424756-6a5a3f9e7543.jpg'); "></div>
      ...
      <div class="block-3 d-md-flex">
        <div class="image" style="background-image: url('img/photo-1511551203524-9a24350a5771.jpg'); "></div>
        <div class="text">
          <h4 class="subheading">Nice text here</h4>
