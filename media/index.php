<?php require_once "includes/header.php"; ?>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(img/madison-yocum-1624867-unsplash.jpg);">
      <div class="container">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 order-md-2">
            <div class="block-16">
              <figure>
                <img src="img/mimi-thian-737001-unsplash.jpg" alt="Image placeholder" class="img-fluid">
    ...
    <section class="site-section bg-light element-animate" id="section-counter">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <figure><img src="img/photodune-3679994-boy-and-girl-at-school-s.jpg" alt="Image placeholder" class="img-fluid"></figure>
          </div>
      ...
      <div class="container-fluid block-11 element-animate">
        <div class="nonloop-block-11 owl-carousel">
          <div class="item">
            <div class="block-19">
                <figure>
                  <img src="img/element5-digital-352046-unsplash.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
          ...
          <div class="item">
            <div class="block-19">
                <figure>
                  <img src="img/photo-1460518451285-97b6aa326961.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
                  <h2 class="heading"><a href="#">Advanced BootStrap Learning</a></h2>
                  <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit qui neque sint eveniet tempore sapiente.</p>
                  <div class="meta d-flex align-items-center">
                    <div class="number">
                      <span>2,219/6,000</span>
          ...
          <div class="item">
            <div class="block-19">
              <figure>
                <img src="img/photo-1498079022511-d15614cb1c02.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="text">
          ...
          <div class="item">
            <div class="block-19">
              <figure>
                <img src="img/photo-1462536943532-57a629f6cc60.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="text">
          ...
          <div class="item">
            <div class="block-19">
                <figure>
                  <img src="img/photo-1457369804613-52c61a468e7d.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
                  <h2 class="heading"><a href="#">Advanced JavaScript Learning</a></h2>
                  <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit qui neque sint eveniet tempore sapiente.</p>
          ...
          <div class="item">
            <div class="block-19">
                <figure>
                  <img src="img/photo-1460518451285-97b6aa326961 (1).jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
                  <h2 class="heading"><a href="#">Advanced JavaScript Learning</a></h2>
                  <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit qui neque sint eveniet tempore sapiente.</p>
      ...
      <div class="container">
        ...
        <div class="row element-animate">
          ...
          <div class="col-md-12 mb-5 mb-lg-0 col-lg-6">
            ...
            <div class="block-20 ">
              <figure>
                <a href="#"><img src="img/element5-digital-352046-unsplash.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="ion-android-calendar"></span> June 10, 2019</a></div>
                  <div><a href="#"><span class="ion-android-person"></span> Admin</a></div>
                  <div><a href="#"><span class="ion-chatbubble"></span> 120</a></div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12 col-lg-6">
            ...
            <div class="block-21 d-flex mb-4">
              <figure class="mr-3">
                <a href="#"><img src="img/photo-1460518451285-97b6aa326961.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
            ...
            <div class="block-21 d-flex mb-4">
              <figure class="mr-3">
                <a href="#"><img src="img/b156ce3c3b4668b81f4873c2eee789a3.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
            ...
            <div class="block-21 d-flex mb-4">
              <figure class="mr-3">
                <a href="#"><img src="img/photo-1554320691-f543fec70942.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="ion-android-calendar"></span>June 10, 2019</a></div>
                  <div><a href="#"><span class="ion-android-person"></span> Admin</a></div>
                  <div><a href="#"><span class="ion-chatbubble"></span> 125</a></div>
                </div>
              </div>
            </div>
            ...
            <div class="block-21 d-flex mb-4">
              <figure class="mr-3">
                <a href="#"><img src="img/photo-1527384025924-f30fc2ac98e3.jpg" alt="" class="img-fluid"></a>
              </figure>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="ion-android-calendar"></span>June 10, 2019</a></div>
                  <div><a href="#"><span class="ion-android-person"></span> Admin</a></div>
                  <div><a href="#"><span class="ion-chatbubble"></span> 195</a></div>
                </div>
              </div>
            </div>
