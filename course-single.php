    ...
    <div class="row align-items-center justify-content-center site-hero-sm-inner">
      <div class="col-md-7 text-center">
        ...
        <div class="mb-5 element-animate">
          ...
          <p class="bcrumb"><a href="index.php">Home</a> <span class="sep ion-android-arrow-dropright px-2"></span> <a href="courses.html">Course</a> <span class="sep ion-android-arrow-dropright px-2"></span>  <span class="current">Advanced JavaScript Learning</span></p>
        </div>
          ...
          <ul>
            <li>
              <a href="#" class="d-flex">
                <figure class="image mr-3">
                  <img src="img/photo-1460925895917-afdab827c52f.jpg" alt="" class="img-fluid">
                </figure>
                <div class="text">
            ...
            <li>
              <a href="#" class="d-flex">
                ...
                <div class="text">
                  <h3 class="heading">Create cool websites </h3>
                  <span class="meta">$34</span>
                </div>
              </a>
            </li>
